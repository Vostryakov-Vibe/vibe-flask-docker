...
## 📋 О проекте
Этот репозиторий содержит изолированное REST API приложение. В версии добавлена оркестрация через **Docker Compose**, что упрощает развертывание и управление контейнером.
